    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 0, new DateTime(2017, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hospital Management System", "In Force", 14 },
                    { 2, true, 0, new DateTime(2018, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "Reporting Tool", "Support", 81 }
                });
