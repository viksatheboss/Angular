...
namespace MvcTaskManager.Migrations
{
    ...
    [Migration("20200329184539_Initial")]
            ...
            modelBuilder.Entity("MvcTaskManager.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new { ProjectId = 1, Active = true, ClientLocationId = 0, DateOfStart = new DateTime(2017, 8, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "Hospital Management System", Status = "In Force", TeamSize = 14 },
                        new { ProjectId = 2, Active = true, ClientLocationId = 0, DateOfStart = new DateTime(2018, 3, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), ProjectName = "Reporting Tool", Status = "Support", TeamSize = 81 }
                    );
                });
